...
class SpotifyService
{
    ...
    {
        $artists = Artist::orderBy('updated_at', 'desc')->take(self::QUERY_AMOUNT)->get();
        foreach ($artists as $artist) {
            $this->_updateArtist($artist);
        }
        return $artists;
